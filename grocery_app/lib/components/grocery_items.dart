          ...
          child: Stack(
            children: [
              widget.isAdmin
                      ...
                      child: CircleAvatar(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            ...
                            context.read<GroceryBloc>().add(RemoveFromShop(
                  ...
                  : Positioned(
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundColor: Colors.white,
                        child: IconButton(
                          icon: widget.shopItem[widget.index][4]
                              ? Icon(
                          ...
                          onPressed: () {
                            ...
                            //     ChangeToCheckmark(
                            //         index: widget.index,
                            //         widget.shopItem: state.widget.shopItems));
                            // context.read<CartBloc>().add(AddToCart(
                            //     index: widget.index,
                            //     widget.shopItems: state.widget.shopItems,
                            //     quantity: quantity));
                          },
                        ),
                      ),
              ...
              Positioned(
                ...
                child: Image.asset(
                  widget.shopItem[widget.index][3],
              ...
              Positioned(
                  ...
                  child: Text(widget.shopItem[widget.index][1],
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () {
                      showDialog(
                        ...
                        builder: (context) => AlertDialog(
                          ...
                          content: Text(
                            "Ordering $quantity ${widget.shopItem[widget.index][1]}\nRs.${quantity * widget.shopItem[widget.index][2]}",
                            style: const TextStyle(
                    ...
                    child: Text(
                      "Buy ${widget.shopItem[widget.index][2]}/-",
                      style: GoogleFonts.notoSerif(
                          color: Colors.black,
                          fontWeight: FontWeight.bold,
                          fontSize: deviceHeight * 0.02),
