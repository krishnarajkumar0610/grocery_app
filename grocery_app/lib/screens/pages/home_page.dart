    ...
    return SafeArea(
        child: Scaffold(
            appBar: AppBar(
              ...
              title: BlocConsumer<ThemeBloc, ThemeState>(
                ...
                child: Column(
                  children: [
                    Padding(
                      ...
                      child: BlocConsumer<GreetingBloc, MyGreetingState>(
                        listener: (context, state) {},
                        builder: (context, state) => Text(
                          state.greeting!,
                          style: GoogleFonts.notoSerif(
            ...
            floatingActionButton: BlocConsumer<InitialShopBloc, ShopState>(
                listener: (context, state) {},
                builder: (context, state) => SingleChildScrollView(
                    child: widget.isAdmin && state is InitialShopState
                        ? floatingButton(
    ...
    return FloatingActionButton.extended(
      ...
      onPressed: () {
        Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => BlocBuilder<InitialShopBloc, ShopState>(
