        ...
        builder:(context, cartState) =>  Scaffold(
            ...
            actions: [
              BlocConsumer<InitialShopBloc, ShopState>(
                ...
                builder: (context, shopBloc) {
                  return cartState is LoadingStateInCart ? const SizedBox() : cartState is MyCartState && cartState.cartItem!.isEmpty
                      ? const SizedBox()
                      : TextButton(
                          onPressed: () {
                            showDialog(
          ...
          body: BlocConsumer<InitialShopBloc, ShopState>(
            ...
            builder: (context, shopState) {
              return cartState is LoadingStateInCart ? const Center(
